<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_updt.aspx.cs" Inherits="user_updt" %>
...
<body>
    ...
    <div>
        ...
        <table border="0" style="width: 100%">
             <tr><td class="title">修改管理员信息</td></tr>
            <tr>
                <td align="left" style="height: 20px">&nbsp;
                   <table align="center"cellpadding="4" cellspacing="0" id="table">                                         
                        <tr>
                            ...
                            <td width="50%">
                                <asp:TextBox ID="username" runat="server" Width="139px" CssClass="textbox"></asp:TextBox>
                        ...
                        ErrorMessage="字母、数字、下划线组成，字母开头，6-10位" ValidationExpression="^[a-zA-Z]\w{5,9}$" ValidationGroup="q"></asp:RegularExpressionValidator>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidatorusername" runat="server" ControlToValidate="username"
                        ...
                        <tr style="color: #000000; font-family: 宋体">
                            ...
                            <td height="25" style="font-family: Times New Roman" width="50%">
                                <asp:TextBox ID="pwd" runat="server" CssClass="textbox"></asp:TextBox>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidatorpwd" runat="server" ControlToValidate="pwd" ErrorMessage="最少6位，包括至少1个大写字母，1个小写字母，1个数字，1个特殊字符" ValidationExpression="^.*(?=.{6,})(?=.*\d)(?=.*[A-Z])(?=.*[a-z])(?=.*[!@#$%^&*? ]).*$" ValidationGroup="q"></asp:RegularExpressionValidator>
                        ...
                        <tr style="font-family: Times New Roman">
                            ...
                            <td height="35" width="50%">
                                <asp:DropDownList ID="cx" runat="server" CssClass="textbox">
                                </asp:DropDownList></td>
                        </tr>
                        <tr style="font-family: Times New Roman">
                            <td height="25" nowrap="nowrap"  class="addtitle">
                                <div align="right">
                                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="修改" CssClass="sure" ValidationGroup="q" /><font
                                    face="宋体">&nbsp;</font>
                            </td>
