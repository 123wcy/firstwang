<%@ Control Language="C#" AutoEventWireup="true" CodeFile="qtdown2.ascx.cs" Inherits="qtdown" %>
<link rel="icon" href="img/favicon.ico" type="image/x-icon">
<link rel="stylesheet" href="lib/css/fontello.css" type="text/css">
  <div class="slogan-bar" style="position: absolute;
    top: 640px;
    padding: 10px 0px;
...
<div class="footer mt30 bgf" style="background: #f2f2f2;
    position: absolute;
    top: 720px;
    width: 100%;">
