   ...
   oDialog.focus();
	...
	<body>
		<form id="Form1" method="post" runat="server">
            <table>
 <tr><td class="title">添加<%=lbtxt %></td></tr>
        </table><br />
			<table width="100%" align="center"  id="table">
				
			<tr><td noWrap class="add">标题:</td>
            ...
            <tr><td  class="add">类别:</td><td width='79%'><asp:TextBox ID='leibie' runat='server' CssClass="text1"></asp:TextBox>*
            ...
            <tr><td noWrap  class="add">首页图片:</td><td width='79%'><asp:textbox id='shouyetupian' Width='395px' runat='server' CssClass="text1"></asp:textbox>&nbsp;
                    <a href="javaScript:OpenScript('hsgupfile.aspx?Result=shouyetupian',500,30)" class="check1">上传</a></td></tr>
            <tr><td noWrap class="add">点击率:</td><td width='79%'><asp:TextBox ID='dianjilv' runat='server' CssClass="text1"></asp:TextBox>*
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatordianjilv" runat="server" ControlToValidate="dianjilv" ErrorMessage="必填"></asp:RequiredFieldValidator>
