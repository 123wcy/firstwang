<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="zhifu_Default" %>
   ...
   <td>
     <TABLE  width="100%" border="0" align="center" id="table">
        <TR>
          ...
          <TD class=form-right>xxxxx：xxxx&nbsp;</TD>
        </TR>
        <TR>
        ...
        <TR>
         ...
         <TR>
          ...
          <TD class=form-star></TD>
          <TD class=form-right> <img src="images/button_sure.gif" onClick="javascript:location.href='../zhifu.aspx?id=<%=nid %>&biao=<%=nbiao %>';"></TD>
        </TR>
</TABLE>
   </td>
