                        ...
                        <tr>
                            <td colspan="3" style="height: 24px">
                                &nbsp; &nbsp;<asp:Button ID="Button1" runat="server" Height="18px" OnClick="Button1_Click"
                                    ...
                                    Text=" 登 陆 " Width="46px" /> <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Style="border-right: #cadcb2 1px solid;
                                    border-top: #cadcb2 1px solid; font-size: 12px; border-left: #cadcb2 1px solid;
                                    color: #81b432; border-bottom: #cadcb2 1px solid; height: 18px" Text="用户注册" />
                                </td>
                        </tr>
                    </table>
                </asp:Panel>
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Style="border-right: #cadcb2 1px solid;
                                    border-top: #cadcb2 1px solid; font-size: 12px; border-left: #cadcb2 1px solid;
                                    color: #81b432; border-bottom: #cadcb2 1px solid; height: 18px" Text="个人后台" />
                                </td>
                        </tr>
                    </table>
                </asp:Panel>
                                ...
                                <td background="qtimages/1_02_01_01_02_02.jpg" height="100" width="220">
                                    <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
                                        <tr>
                                            <td width="5%">
                                                &nbsp;</td>
                                            <td width="90%" class=newsline height="150px">
